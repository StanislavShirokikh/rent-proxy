...
public class DeleteEntityTest {
    ...
    public void deletePost() {
        ...
        Assertions.assertNull(postRepository.findPostById(savedPost.getId()));
        Assertions.assertNull(rentConditionInfoRepository.findRentConditionInfoByPostId(savedPost.getId()));
        Assertions.assertNull(apartmentInfoRepository.findApartmentInfoByPostId(savedPost.getId()));
        Assertions.assertNull(houseInfoRepository.findHouseInfoByPostId(savedPost.getId()));
    }
}
