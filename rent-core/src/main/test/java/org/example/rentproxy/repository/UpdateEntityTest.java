...
public class UpdateEntityTest {
    ...
    public void updatePostById() {
        ...
        Assertions.assertNotNull(actualPost.getUser().getId());
        ...
        Assertions.assertNotNull(actualPost.getRentConditionInfo().getId());
        Assertions.assertNotNull(actualPost.getRentConditionInfo().getPost().getId());
        ...
        Assertions.assertNotNull(actualPost.getApartmentInfo().getId());
        Assertions.assertNotNull(actualPost.getApartmentInfo().getPost().getId());
        Assertions.assertNotNull(actualPost.getApartmentInfo().getBathroomType().getId());
        assertEquals(updatedPost.getApartmentInfo().getBathroomType().getName(), actualPost.getApartmentInfo().getBathroomType().getName());
        Assertions.assertNotNull(actualPost.getApartmentInfo().getRepairType().getId());
        assertEquals(updatedPost.getApartmentInfo().getRepairType().getName(), actualPost.getApartmentInfo().getRepairType().getName());
        Assertions.assertNotNull(updatedPost.getApartmentInfo().getBalconyType().getId());
        assertEquals(updatedPost.getApartmentInfo().getBalconyType().getName(), actualPost.getApartmentInfo().getBalconyType().getName());
        Assertions.assertNotNull(actualPost.getApartmentInfo().getRoomsType().getId());
        ...
        Assertions.assertNotNull(actualPost.getHouseInfo().getId());
        Assertions.assertNotNull(actualPost.getHouseInfo().getPost().getId());
        Assertions.assertNotNull(actualPost.getHouseInfo().getHouseType().getId());
        ...
        Assertions.assertNotNull(actualPost.getRentType().getId());
